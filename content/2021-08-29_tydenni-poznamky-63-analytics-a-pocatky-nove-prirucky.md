...
Příručku jsem si začal připravovat [tady vedle](https://junior.guru/handbook/). Jelikož jsem ToC dělal v historii JG už asi popáté, měl jsem už poměrně jasnou představu, co od toho chci a jak technicky (ne)komplikované to má být. Po jednom dni jsem tedy měl ToC hotovou a jsem s ní celkem spokojený. Ještě by šla vylepšovat, třeba ukazovat aktuální nadpis při scrollování, ale to si nechám na jindy. Kdo jste na mobilu, tak tam se ToC jen složí pod článek. Uvidím, jestli to bude stačit takhle, nebo mi budou lidi psát, že by chtěli lepší navigaci.
