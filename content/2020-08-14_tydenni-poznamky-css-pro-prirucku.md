...
- Ladil CSS žlutě zvýrazněných bloků, které na JG upozorňují na různé další věci. Dělal jsem ho obecnější a méně psychedelické, abych tyto bloky mohl použít s různým obsahem a v různých kontextech.
