...
![Fayn]({filename}/images/fayn.png){: .right}Odešel jsem od **Vodafone**, kterému jsem za mobilní služby platil **měsíčně 700-800 Kč**. Nyní mám tarif u **Fayn** a srovnatelné služby by měly stát **300-400 Kč**. Na první faktuře (kde mám ale o polovinu nižší spotřebu služeb) jsem zaplatil **215 Kč**.
...
![kolik jsem platil u Vodafone]({filename}/images/vodafone-platby.png)
...
![komentář od Bantera]({filename}/images/banter-tarifomat.png)
...
![dTest a tarify]({filename}/images/dtest-tarify.png)
...
![vyplňování smlouvy]({filename}/images/fayn-smlouva.png)
...
![administrace ve Fayn]({filename}/images/fayn-admin.png)
...
![faktura od Fayn]({filename}/images/fayn-faktura.png)
