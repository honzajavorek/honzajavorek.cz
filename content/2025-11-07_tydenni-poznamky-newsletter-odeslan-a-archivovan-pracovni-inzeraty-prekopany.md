Title: Týdenní poznámky: Newsletter odeslán a archivován, pracovní inzeráty překopány
...
![Buttondown]({static}/images/screenshot-2025-11-07-at-15-17-06-rijen-2025-ve-svete-it-junioru-emails-buttondown.png){: .img-thumbnail }

## Archiv newsletteru na webu

Buttondown [má nějaký archiv](https://buttondown.com/juniorguru/archive/) pro odeslané newslettery, ale já jsem to chtěl mít přímo na webu. A taky jsem chtěl mít kopii pro svoje potřeby, kdybych někdy v budoucnu měnil poskytovatele a tak.

Takže jsem překopal [junior.guru/news](https://junior.guru/news) a vytvořil tam archiv jednotlivých vydaných čísel. Teď když jsem měl aspoň jedno odeslané už to šlo udělat 😀
...
![Archiv]({static}/images/screenshot-2025-11-05-at-11-55-01-novinky-pro-zacatecniky-v-programovani.png){: .img-thumbnail }

![Archiv jednoho vydání]({static}/images/screenshot-2025-11-07-at-15-28-57-rijen-2025-ve-svete-it-junioru.png){: .img-thumbnail }
...
Ale stihl jsem si přes _vibe coding_ upravit svoje [udělátko na sdílení článků na LinkedIn](https://github.com/honzajavorek/posse/). Přidání podpory pro junior.guru newsletter bylo celkem přímočaré, zaseklo se to akorát na tom, že jsem chtěl před vložením ještě nějaké věci transformovat. Text e-mailu je totiž formátovaný spíš jako obyčejný text pro e-mailové klienty. Na LinkedIn se hodilo některé věci předělat jako _code block_ nebo jako seznam. To všechno moje udělátko teď zvládne.
...
![LinkedIn]({static}/images/screenshot-2025-11-07-at-15-35-20-rijen-2025-ve-svete-it-junioru-linkedin.png)
LinkedIn

![Discord]({static}/images/screenshot-2025-11-07-at-15-35-47.png)
Discord
...
Prohrabal jsem se až do hlubin _crawleru_, který mi stahuje data o tom, co se napsalo na Discordu. Zjistil jsem, že špatně vyhodnocuji, jaká vlákna přeskočit a jaká stáhnout. Jenže neexistoval způsob, jak to vyhodnocovat správně. Myslel jsem si, že bych si jen přečetl datum archivace vlákna, ale jak je naznačeno výše, pak jsem zjistil, že toto datum většinou vůbec není nastaveno – pouze pokud někdo archivoval vlákno ručně, ne když se archivuje samo od sebe.

Nakonec jsem musel _crawler_ nechat procházet všechna vlákna, na která narazil. Až pokud v daném období nemají žádné zprávy, tak se přeskočí. Snažil jsem se to napsat co nejefektivněji, ale i tak se dost prodloužila doba, která je potřeba ke stažení dat z Discordu. Jenže s tím prostě asi nic neudělám.
...
Tak jsem zkusil _vibe coding_ zase. Nechal jsem Copilota nakódit parser na můj nákupní lístek. Pak jsem označil kurzorem text v PDF a vykopíroval do obyčejného texťáku. Nechal jsem ho nakódit parser na tenhle – pro člověka skoro nečitelný – texťák. Zadával jsem práci tak, že jsem v Pythonu napsal vždycky pár testů, do kterých se musel vlézt. Tím jsem měl jistotu, že to snad nějak funguje.

Pak jsem nechal Copilota dokódit i zbytek programu, kde to napároval na sebe podle ID zboží v URL, spočítal kusy, a vyhodil finální cenu. Pokud něco nesedělo (kamarád koupil jiný sýr, nebo něco zapomněl koupit), vypsal to nakonec jako _discrepancies_. Ty jsem si už ručně dořešil sám.
...
Ze StartupJobs inzeráty nescrapuji, ale používám API, které jsme si kdysi dohodli. Akorát že dost často [nefunguje](https://mastodonczech.cz/@honzajavorek/115490276997023858), protože jim lidi do inzerátů narvou divné znaky a do toho XML se to překóduje nějak špatně.
...
![XML chyba]({static}/images/ac9d4345ed148ac6.png)
...
Pustil jsem si [Designing the Ideal Bootstrapped Business with Jason Cohen](https://www.youtube.com/watch?v=otbnC2zE2rw) a i když je junior.guru opakem byznysu, o jakém tam mluví, tak mě to trochu inspirovalo a nakoplo.
...
Taky bych měl časem překopat tu prodejní stránku podle toho, jak jsme to vymysleli s Terezou. Zatím mám pořád tu původní, byť prošla úpravami, ale chybí tam třeba _testimonials_ a tak.

Když jsem byl v těchto úvahách, podíval jsem se na skupinu [Programátoři začátečníci](https://www.facebook.com/groups/programatorizacatecnici/) na Facebooku. Zdá se mi to, nebo to tam úplně umřelo? Spořka tam dle mých informací svého času nalila mega, pak to tam chvíli roztleskávala nějaká agentura, a poslední dobou mám pocit, že si tam píšu v podstatě sám se sebou.

Jsem se jich kdysi bál, že to bude konkurence, ale teď mám spíš pocit, že si je za pár let koupím, jako [Pinboard kdysi koupil Delicious](https://en.wikipedia.org/wiki/Delicious_(website)) 😀

## CodeRabbit

Zkouším CodeRabbit. Chápu, že je to pro jiné lidi, než jednočlenné _solopreneurs_, kteří všechno mastí do hlavní větve a pouze občas vytvoří Pull Request, ale když už jsem ho teda vytvořil, dostal jsem tunu nepotřebného textu, ASCII art, básničku a 3 critical komentáře, které vychází z nepochopení toho, jak projekt funguje.

Na menším a standardnějším projektu by to něco vychytat mohlo, dám tomu ještě šanci, ale ta _1st time experience_ je stejně jako u agentů příšerná.

Zapnul jsem ho pro jistotu všude, takže jsem pak řešil, že to otravovalo lidi v [eggtray](https://github.com/juniorguru/eggtray) (registr juniorů). Trochu jsem to zkusil nastavit, vypnout básničky a tak…
...
-   Připravovali jsme s Táňou [klubové akce na další měsíce](https://junior.guru/events/).
...
- [Designing the Ideal Bootstrapped Business with Jason Cohen - YouTube](https://www.youtube.com/watch?v=otbnC2zE2rw)<br>Tohle je úplně skvělá přednáška. Škoda, že všechno, co doporučuje, je přesným opakem toho, čím je můj byznys 🤣️️️️️️ A škoda, že počítání je můj kryptonit, takže když tam má nějakou rovnici příjmů a nákladů na akvizici zákazníka, tak slyším jen „bla bla bla bla“ 😀
- [4 Kavky ve světě deskovek končí](https://www.4kavky.cz/nase-novinky/4-kavky-ve-svete-deskovek-konci/)<br>Deskovkáři končí, protože lidi nakupují fejky z Temu místo originálů.
- [Bohatí Evropané ničí klima násobně více než ti chudí, ukázal nový výzkum](https://denikreferendum.cz/clanek/238125-bohati-evropane-nici-klima-nasobne-vice-nez-tichudi-ukazal-novy-vyzkum)<br>„…polovina Evropanů s nejnižšími příjmy snížila své emise oproti roku 1990 o dvacet sedm procent, zatímco nejbohatší desetina procenta Evropanů své emise naopak o čtrnáct procent zvýšila.“
- [Stop Citing AI](https://stopcitingai.com/)<br>Pamatuju, jak vznikaly takové ty stránky „let me google it for you“, které se lidem posílaly jako odpověď na otázku, kterou mohli zadat do vyhledávače. Byla tam animace a vysvětlení, co měli udělat, a pak to přesměrovalo. Tohle je geneze pro rok 2025: web, který dotyčnému vysvětluje, že se provinil hříchem citování AI jako zdroje faktů. Můžete si uložit a posílat lidem jako univerzální argument. Přeloží někdo do češtiny?
- [Free software scares normal people](http://danieldelaney.net/normal/)<br>Amen.
